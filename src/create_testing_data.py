...
filename = "Stock_testing_data.csv"
...
with open(ticker + "_stock_data.csv", "r") as in_file, open("Stock_testing_data.csv", "w", newline="") as out_file:
    ...
    print("Success! CSV table should be in the folder this script is in, with the name: Stock_testing_data.csv")
